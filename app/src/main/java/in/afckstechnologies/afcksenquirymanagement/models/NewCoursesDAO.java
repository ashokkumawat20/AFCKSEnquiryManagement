...
public class NewCoursesDAO {
    ...
    public NewCoursesDAO(String id, String course_type_id, String course_code, String course_name, String time_duration, String prerequisite, String recommonded, String fees, String isselected, boolean isSelected) {
        this.id = id;
        this.course_type_id = course_type_id;
        this.course_code = course_code;
        this.course_name = course_name;
