...
import in.afckstechnologies.afcksenquirymanagement.utils.SmsReceiver;
import in.afckstechnologies.afcksenquirymanagement.utils.WebClient;

public class EnquiryVerfiyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enquiry_verfiy);
        ...
        SmsReceiver.bindListener(new SmsListener() {
            ...
            public void messageReceived(String messageText) {
                String companyFlag = messageText.substring(19);
    ...
    private class smspassAvailable extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(EnquiryVerfiyActivity.this);
    ...
    private class userAvailable extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void args) {
            if (status) {
                ...
                String message = "AFCKS Enquiry code " + id;
...
// Process line...
    ...
    private class submitData extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            jsonObj = new JSONObject() {
                {
                    try {
                        put("id", user_id);
                        put("enquiry_mobile_deviceid", deviceId);
            ...
            Log.i("json", "json" + jsonObj);
            trainerResponse = serviceAccess.SendHttpPost(Config.URL_UPDATEENQUIRYDETAILS, jsonObj);
            Log.i("resp", "centerListResponse" + trainerResponse);
        ...
        protected void onPostExecute(Void args) {
            if (status) {
                mProgressDialog.dismiss();
                try {
                    prefEditor.putString("enquiry_user_id", user_id);
                    prefEditor.putString("phone_no", phoneno);
                    prefEditor.putString("enquiry_mobile_deviceid", deviceId);
                    prefEditor.putString("enquiry_user_name", jsonObject.getString("trainer_name"));
                    prefEditor.commit();
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                ...
                Toast.makeText(getApplicationContext(), msg, Toast.LENGTH_LONG).show();
                finish();
                Intent intent = new Intent(EnquiryVerfiyActivity.this, SplashActivity.class);
