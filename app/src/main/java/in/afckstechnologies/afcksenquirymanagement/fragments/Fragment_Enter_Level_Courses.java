    ...
    private class getCoursesList extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            if(!preferences.getString("user_id", "").equals("")) {
                cursor = db.getCourses(Integer.parseInt(preferences.getString("user_id", "")), 1);
            ...
            if (cursor.moveToFirst()) {
                do {
                    if(cursor.getString(cursor.getColumnIndex(StudentContract.Courses.COLUMN_NAME_COURSE_TYPE_ID)).equals("1")) {
