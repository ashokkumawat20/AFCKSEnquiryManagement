 ...
 */
public class DisplayStudentEditPreActivity1 extends Fragment {
...
private Paint p = new Paint();
    public DisplayStudentEditPreActivity1() {
        ...
        Thread objectThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (c.moveToFirst()) {
                    do {
                        status = true;
                        studentArrayList.add(new StudentListDAO(c.getString(c.getColumnIndex("Details")), c.getString(c.getColumnIndex("id")), c.getString(c.getColumnIndex("first_name")), c.getString(c.getColumnIndex("last_name")), c.getString(c.getColumnIndex("mobile_no")), c.getString(c.getColumnIndex("email_id")), c.getString(c.getColumnIndex("email_id"))));
                    } while (c.moveToNext());
                }
