...
public class Config {
    ...
    public static final String URL_UPDATEUSERDETAILSOFFLINE = BASE_URL + "user/updateuserdetailsoffline";
    ...
    public static final String URL_UPDATEENQUIRYDETAILS = BASE_URL + "user/updateenquirydetails";
    public static final String URL_AVAILABLE_MOBILE_DEVICEID = BASE_URL + "user/getAvailableEQAppMobileDeviceID";
    ...
    public static final String URL_GETALLUSERS = BASE_URL + "user/getAllUsers";
    public static final String URL_GETALLVWLOCATIONSDEMANDEDUSERWISE = BASE_URL + "user/getAllvwLocationsDemandedUserWise";
    public static final String URL_GETALLVWCOURSEDEMANDEDUSERWISE = BASE_URL + "user/getAllvwCourseDemandedUserWise";
    public static final String URL_GETALLTRAINERSTEMPLATE = BASE_URL + "user/getAllTrainersTemplate";
    public static final String URL_GETALLVWDETAILSSTUDENTSINBATCH = BASE_URL + "user/getAllvwDetailsStudentsInBatch";
    public static final String URL_GETALLVWBATCHSTARTINGDETAILS = BASE_URL + "user/getAllvwBatchStartingDetails";
    public static final String URL_GETALLVWVIEWSTUDENTATTENDANCE = BASE_URL + "user/getAllvwViewStudentAttendance";
    public static final String URL_GETALLBRANCHESDETAILS = BASE_URL + "user/getAllBranchesDetails";
    public static final String URL_GETALLCOURSESDETAILS = BASE_URL + "user/getAllCoursesDetails";
    public static final String URL_GETALLCOURSESTYPE = BASE_URL + "user/getAllCoursesType";
    public static final String URL_GETALLDAYPREFRENCE = BASE_URL + "user/getAllDayPrefrence";
    public static final String URL_GETALLUSERDAYPREFRENCE = BASE_URL + "user/getAllUserDayPrefrence";
    public static final String URL_GETALLSTUDENTCOMMENTS = BASE_URL + "user/getAllStudentComments";
    public static final String URL_GETALLLOGINLOGS = BASE_URL + "user/getallLoginLogs";
