...
public class CenterListAdpter1 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    String bid, branchName;
    //database helper object
    private StudentProvider.AFCKSDatabase db;

    // create constructor to innitilize context and data sent from MainActivity
    public CenterListAdpter1(Context context, List<CenterDAO> data) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        CenterListAdpter1.MyHolder holder = new CenterListAdpter1.MyHolder(view);
        return holder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        final CenterListAdpter1.MyHolder myHolder = (CenterListAdpter1.MyHolder) holder;
            ...
            public void onClick(View v) {
                if (AppStatus.getInstance(context).isOnline()) {
                    ...
                    if (cb.isChecked()) {
                        ...
                        branchName = data.get(pos).getBranch_name();
                        myHolder.chkSelected.setChecked(true);
                    ...
                    if (cb.isChecked()) {
                        ...
                        branchName = data.get(pos).getBranch_name();
                        myHolder.chkSelected.setChecked(true);
                        db.addUserLoc("", id, branchName, preferences.getString("user_id", ""), 0);
                        ...
                        id1 = data.get(pos).getId();
                        myHolder.chkSelected.setChecked(false);
                        db.updateLocDeleteStatus(preferences.getString("user_id", ""), Integer.parseInt(id1), 3);
                        Config.VALUE.remove(data.get(pos).getId());
    ...
    private class submitData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void args) {
            if (status) {
                prefEditor.putString("center_flag", "1");
                prefEditor.commit();
                db.addUserLoc(bid, id, branchName, preferences.getString("user_id", ""), 1);
    ...
    private class deleteSale extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void args) {
            if (status) {
                db.deleteLoc(id1, preferences.getString("user_id", ""));
