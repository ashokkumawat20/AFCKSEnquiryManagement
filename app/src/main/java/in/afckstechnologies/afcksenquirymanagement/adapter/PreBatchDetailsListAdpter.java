...
public class PreBatchDetailsListAdpter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        myHolder.view_fees.setText(current.getDue_amount());
        ...
        if (current.getStatus().equals("0") && !current.getStudent_batch_cat().equals("5")) {
            myHolder.i_prebatch.setBackgroundColor(context.getResources().getColor(R.color.color_rbutton));
        }
        if (current.getStatus().equals("1")&& !current.getStudent_batch_cat().equals("5")) {
        ...
        if (current.getStudent_batch_cat().equals("5")) {
            myHolder.i_prebatch.setBackgroundColor(context.getResources().getColor(R.color.rating_c));
        }
