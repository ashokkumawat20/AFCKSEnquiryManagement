...
import in.afckstechnologies.afcksenquirymanagement.MailAPI.GMailSender1;
import in.afckstechnologies.afcksenquirymanagement.R;
import in.afckstechnologies.afcksenquirymanagement.activity.DisplayCurrentContactsActivity;
import in.afckstechnologies.afcksenquirymanagement.activity.UpdateTemplateContactsActivity;
...
public class TemplateListAdpter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if(preferences.getString("templateon","").equals("0")) {
            prefEditor.remove(current.getID());
            prefEditor.commit();
        }
                                ...
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    if (!sms_type.equals("")) {
                                        if (sms_type.equals("Mobile_SMS")) {
                                            ...
                                            prefEditor.putString("templateon", "1");
                                            prefEditor.putBoolean(current.getID(), true);
                                            prefEditor.commit();
                                           ...
                                           /* Log.i("call ph no", "" + preferences.getString("student_mob_sms", ""));
                                            ...
                                            try {
                                               ...
                                               else if (preferences.getString("enquiry_user_id", "").equals("AK")) {
                                                    i.setPackage("com.whatsapp.w4b");
                                                }
                                                else {
        ...
        if (preferences.getBoolean(current.getID(), false)) {
            myHolder.layoutColor.setBackgroundColor(Color.parseColor("#70AD47"));
        } else {
            myHolder.layoutColor.setBackgroundColor(Color.parseColor("#556199"));
        }
